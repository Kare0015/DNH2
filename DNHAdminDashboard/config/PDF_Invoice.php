...
class PDF_Invoice extends \Codedge\Fpdf\Fpdf\Fpdf
{
// private variables
    var $colonnes;
    var $format;
...
// Invoice
    ...
    function addDate( $date )
    {
        ...
        $this->Cell(10,5, "Factuur datum", 0, 0, "C");
...
// Mode of payment
    function addReglement( $mode )
    {
        ...
        $this->SetFont( "Arial", "B", 10);
        $this->Cell(10,4, "Factuurnummer", 0, 0, "C");
...
// Expiry date
    function addEcheance( $date )
    {
        ...
        $this->SetXY( $r1 + ($r2 - $r1)/2 - 5 , $y1+1 );
        $this->SetFont( "Arial", "B", 10);
        $this->Cell(10,4, "Verloopdatum factuur", 0, 0, "C");
        $this->SetXY( $r1 + ($r2-$r1)/2 - 5 , $y1 + 5 );
        $this->SetFont( "Arial", "", 10);
        $this->Cell(10,5,$date, 0,0, "C");
    }
